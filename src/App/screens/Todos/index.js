...
import { getEntitiesByFilter } from 'App/stores/resources'
...
const Todos = ({ todos, addTodo, toggleTodo, filterTodos, currentFilter }) => {
  return (
...
export default connect(
  state => ({
    todos: getEntitiesByFilter('todos')(state),
